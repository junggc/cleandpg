<!-- ========================================================
/application/views/cart/cart_guest_subscribe.php 참고 페이지 

#회원정보 인증버튼 연결해수제요

#전체동의 , 선택항목도 포함합니다. 부분도 체크했을때 안했을때 값 확인해주세요
 /application/views/member/join_v 참고

#결제완료페이지는 동일하게 사용할꺼 같습니다. 문구를 추가해야 하는부분이있어서
결제완료에 값 넘기는 작업하실때 한번 불러주세요
=========================================================  -->
...
<form id="frmRecommendCart" onsubmit="return false;">
    <div class="inner">
        <div class="cart-step">
            <!-- 1. 구독 -->
            <div class="step3">
