				<div class="col-box" id="subscribe_3" style="display:none">
					...
					<div>
                                            <div class="payment-kind">
                                                <h5>결제수단 선택</h5>
                                                <div class="list mb40">
                                                    <div class="mb10 starter_pay"><button class="btn2 pay2" a="direct"><span>실시간계좌이체</span></button></div>
                                                    ...
                                                    <div class="mb10 starter_pay"><button class="btn2 pay6" a="samsung"><span>삼성페이</span></button></div>
                                                </div>
                                            </div>
...
$(document).ready(function(e) {
	...
	$('#btn_step3').on('click', function() {
		<?php
			...
			else echo 'fnPaymentRequest($("#frmSave"));';
		?>
	});
