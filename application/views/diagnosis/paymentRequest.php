        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.data.gopaymethod == 'kakao') {
                        ...
                        if (data.order_type == 'subscribe' || data.order_type == 'with') {
                    ...
                    } else if (isMobile() && data.order_type != 'subscribe') {
                        ...
                        if(data.order_type != 'subscribe' && data.order_type != 'with'){
                            ...
                            $.ajax({
                                ...
                                success: function () {
                                    location.href = "https://dev.cleand.kr/diagnosis/payment_result?merchantData=" + data.data.merchantData
                                }
                            });
