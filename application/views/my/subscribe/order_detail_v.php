	...
	<div class="inner">
		...
		<div class="mypage">
			...
			<div class="container">
				...
				<h3 class="h3"><a href="<?php echo $move; ?>" class="link m back">구독내역 상세</a></h3>
						...
						?>
							<tr>
								...
								<td class="f20" rowspan="<?php echo count($info['list']); ?>"><?php echo $info['status_name']; ?>
									...
									?>
                                	<div class="mt10"><a href="#" class="btn-under">배송조회</a></div>
                                    <?php
										}
									?>
                                </td>
								<td class="f20" rowspan="<?php echo count($info['list']); ?>">
									<div class="btn-box-table">
                                    	<?php
											if($info['status'] == 'COMPLETE' && $info['item_cnt'] > $info['review_cnt']) {
										?>
							...
							<div class="item">
								...
								<div class="btns-box">
									...
									<div class="btns">
										...
										?>
										<a href="#" onclick="javascript:fnCancel(); return false;" class="btn btn-type1 btn-m">결제취소</a>
                                        <?php
											}
											if($info['status'] == 'PAYMENT') {
												if($info['payMethod'] == 'VBank' || $info['payMethod'] == 'VBANK') {
										?>
										<a href="#" onclick="javascript:fnShowCancel(); return false;" class="btn btn-type1 btn-m">결제취소</a>
                                        <?php
												}
												else {
										?>
