<!-- ========================================================
/application/views/cart/car_calendar.php 참고 페이지 
=========================================================  -->
...
<div id="subscribe_2" style="">
    ...
    <div class="btn-box-common1">
        <!-- recommend_guest_subscribe => 비회원일때 이동 버튼 /  recommend_member_subscribe => 회원일때 이동 버튼   -->
        <!--<a href="/cart/recommend_guest_subscribe" class="btn btn-type1" id="">선택완료</a>-->
        <a href="javascript:window.history.back();" class="btn btn-type2 mo" id="btn_step2">이전</a>
        <a href="/cart/recommend_member_subscribe" class="btn btn-type1" id="">선택완료</a>
    </div>
        </div>
</div>
